...
public class wordCountSolution {
    ...
    public wordCountSolution(String strFN) {
    ...
    public static void main(String[] args) {
        ...
        startTime = System.currentTimeMillis();
        wordCountSolution wc = new wordCountSolution("/home/theo/Documents/MASTER/Theo_Nazon/INF727_TP/CC-MAIN-20170322212949-00140-ip-10-233-31-227.ec2.internal.warc.wet");
        wc.readLines_new();
        ;
